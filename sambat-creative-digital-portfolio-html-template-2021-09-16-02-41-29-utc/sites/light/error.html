...
<body>
    ...
    <div id="spiral">
        <div class="main-head">
            ...
            <div class="error-page text-center">
                ...
                <a href="index.html" class="load-spiral hover-target">Back to home</a>
            </div>
        </div>   
    ...
    <div class="menus">
        ...
        <a class="hover-target" href="work-detail.html">Work Detail 2</a>
        <a class="hover-target" href="blog.html">Blog</a>
        <a class="hover-target" href="blog-detail-2.html">Blog Detail</a>
